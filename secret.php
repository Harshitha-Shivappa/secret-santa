<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){ 
        ...
        if(empty($email_err) && empty($address_err) && empty($city_err)) {
            $sql = "INSERT INTO santa (Email, City, C_email, Address) VALUES (?, ?, ?, ?)";
            
            if($stmt = mysqli_prepare($link, $sql)) {
                mysqli_stmt_bind_param($stmt, "ssss", $param_email, $param_city, $param_cemail, $param_address);
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    /* echo '<script>alert("😎Well Done!!! Your child is waiting for you 🤗 You will get to know about your child via email.")</script>';  */
                   
                   /*  echo "<script> alert('😎Well Done!!! Your child is waiting for you 🤗 You will get to know about your child via email.');
